 ...
 * 暂时无用
 */
public class UserJournalRecord {
    private Long journalId;
    
    private Long journalParentid;
    ...
    public Long getJournalParentid() {
		return journalParentid;
	}

	public void setJournalParentid(Long journalParentid) {
		this.journalParentid = journalParentid;
	}
