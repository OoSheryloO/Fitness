 ...
 * <p>Description: 定制随机数</p>
 * <p>Company: huban </p>
 * @author Sheryl
 * @created 2017年9月20日 下午2:12:24
 */
public class RandomUtil{
	...
	public static void main(String[] args) {
		...
		System.out.println("根据数字生成一个定长的字符串，长度不够前面补0:" + toFixdLengthString(1, 15));
		int[] in = { 1, 2, 3, 4, 5, 6, 7 };
		System.out.println("每次生成的len位数都不相同:" + getNotSimple(in, 3));
	}
//	public static void main(String[] args) {
//		BigDecimal bigDecimal = (new BigDecimal(500).setScale(3).divide(new BigDecimal(1000).setScale(3))).multiply(new BigDecimal(5).setScale(3));
//		int iIntegral = 600 / 1000 * 5;
