 ...
 * <p>Description: 参数Utils for databases</p>
 * <p>Company: huban hangzhou</p>
 * @author Sheryl
 * @created 2017年9月18日 下午5:54:43
 * //命名前缀：
	byte b    char c    short sh    int i    long l    char c    string s    float f    double d    
	hashtable h	[] arr    List lst    Vector v    Boolean b    StringBuffer sb    Byte bt    Map map
 */
public class ArgumentsUtils {
	// 数据库 参数
	public static final String sIDKey = "ID";//主键ID
	...
	public static final String sMonthlysTimeKey = "MonthlysTime";
