...
import com.code.domain.Userlog;
...
public class UserlogController extends BaseController {
    ...
    public Map searchUserlogPage(int status, String search, int pageNumber, int pageSize, HttpServletRequest request) {
        ...
        PageInfo<Userlog> page = this.ReadUserlogService.SearchPage(mapSearch, pageNumber, pageSize);
    ...
    public Map setUserlogStatus(String data){
        Map<String, Object> mapResult = new HashMap<String, Object>();
        Map<String, Object> mapSearch = new HashMap<String, Object>();
    ...
    public Map searchUserlog(@PathVariable("id") String Id){
        Map<String, Object> mapResult = new HashMap<String, Object>();
        Map<String, Object> mapSearch = new HashMap<String, Object>();
        Userlog temp = ReadUserlogService.SearchBySpecial(Id);
        if(temp != null){
        	mapResult.put("code", 0);
    ...
    public Map modifyUserlog(String data, HttpServletRequest request) {
        Map<String, Object> mapResult = new HashMap<String, Object>();
        Userlog temp = JSON.parseObject(data, Userlog.class);
        ...
        if("0".equals(temp.getId())){
            ...
            obj = ReadUserlogService.SearchBySpecial(String.valueOf(temp.getId()));
            if(obj==null){
                isNew=true;
            }
        }
