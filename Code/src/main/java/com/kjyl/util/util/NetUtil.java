...
public class NetUtil {
	...
	public static JSONObject doPostStr(String url, String param) throws ParseException, IOException {
		...
		try {
			...
			e.printStackTrace();
//			ErrorUtil.HandleError(null, "com.huban.util.doPostStr", e);
		}
	...
	public static JSONObject doGetStr(String url) throws ParseException, IOException {
		...
		try {
			...
			e.printStackTrace();
//			ErrorUtil.HandleError(null, "com.huban.util.doGetStr", e);
		}
		return jsonObject;
	}
	...
	public static JSONObject doGet(String url) {
		...
		try {
			...
			try {
				...
				e2.printStackTrace();
//				ErrorUtil.HandleError(null, "com.huban.util.doGet", e2);
			}
		}
		return json;
	...
	public static JSONObject doPost(String url, String param) {
		...
		try {
			...
			e.printStackTrace();
//			ErrorUtil.HandleError(null, "com.huban.util.doPost", e);
		} finally {
			try {
				if (out != null) {
					out.close();
				...
				System.out.println("关闭请求流出现异常！" + e2);
				e2.printStackTrace();
//				ErrorUtil.HandleError(null, "com.huban.util.doPost", e2);
			}
		}
		return jsonObject;
	}
