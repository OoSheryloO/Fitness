...
public class Clubcard implements Serializable {
	...
	*/ 
	...
	@ApiModelProperty(value = "['Id','俱乐部-卡片']['UseId','使用Id']['LogicId','逻辑Id']['Memo','备注']['Status','状态信息']['Delete','是否删除']['CreateTime','创建时间']['ModifyTime','修改时间']")
	@JSONField(serialize = false)
	public String ClubcardField;
}
