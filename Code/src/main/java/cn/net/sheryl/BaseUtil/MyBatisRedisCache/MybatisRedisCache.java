package cn.net.sheryl.BaseUtil.MyBatisRedisCache;

/**
 * Created by SASR_Studio on 2016-11-10.
 */
...
import cn.net.sheryl.BaseUtil.SerializeUtil;
...
public class MybatisRedisCache implements Cache {
    ...
    public MybatisRedisCache(final String id) {
        ...
        jedisPool = new JedisPool(jedisPoolConfig, "114.215.196.164", 6379,2000,"hubankejiredIS2016");
