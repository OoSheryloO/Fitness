...
//		List<Notices> lsWc = noticesService.getNoticesList(checkParammap1);
//		
//		int sum=0;
//		int citysum=0;
//		int prosum=0;
...
//			List<Notices> lsWc2 = noticesService.getNoticesList(checkParammap2);//按AreaID地区找出多少条
//			
...
//					
//					List<Notices> notices=noticesService.getNoticesList(checkParammap3);
//					if(notices.size()>0)
//					{
...
//													List<Notices> notices = noticesService.getNoticesList(checkParammapMap5);
//													if (notices.size() > 0) {
